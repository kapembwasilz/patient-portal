...
if (isset($_POST['apply'])) {
	...
	if (count($error) == 0) {
		...
		$query = "INSERT INTO doctors(firstname,surname,username,email,gender,phone,country,password,salary,data_reg, status, profile) VALUES('$firstname','$surname','$username','$email','$gender','$phone','$country','$password','0',NOW(),'Pendding','doctor.jpeg')";
...
<body style="background-image: url(img/back.webp);background-size: cover;background-repeat: no-repeat;">
		...
		<div class="col-md-12">
			<div class="row">
				...
				<div class="col-md-6 my-3 jumbotron">
					<h5 class="text-center">Appy Now!!!</h5>
					<div>
						<?php echo $show; ?>
					</div>
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<select name="gender" class="form-control"><option value="">Select Gender</option>
						...
						<div class="form-group">
							...
							<select name="country" class="form-control"><option value="">Select Country</option>

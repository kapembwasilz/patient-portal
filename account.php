...
if (isset($_POST['create'])){
	...
	if (count($error)==0) {
		$query = "INSERT INTO patient(firstname,surname,username,email,phone,gender,country,password,data_reg,profile) VALUES('$fname','$sname','$uname','$email','$phone','$gender','$country','$password',NOW(),'patient.jpeg')";
...
<body style="background-image: url(img/back.webp);background-repeat: no-repeat; background-size: cover;">
	<?php
